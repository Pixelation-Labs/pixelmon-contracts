...
const { deployContract, NOT_CURRENT_OWNER, METADATA_BASE_URI, NEW_METADATA_BASE_URI } = require("./utils");
...
beforeEach(async function () {
    const { minterWallet, deployerWallet, anonymousWallet, newContractOwnerWallet, pixelmonTrainerGearContract, allowedToTransferWallet } =
        await deployContract();

    minter = minterWallet;
    deployer = deployerWallet;
    anonymous = anonymousWallet;
    newContractOwner = newContractOwnerWallet;
    contract = pixelmonTrainerGearContract;
    allowedToTransfer = allowedToTransferWallet;
});

describe("PixelmonTrainerGearContract deployment test", function () {
