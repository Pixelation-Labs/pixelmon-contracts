...
async function main() {
    ...
    const PixelmonTrainerAdventure = await hre.ethers.getContractFactory("Pixelmon");
    const pixelmonTrainerAdventure = await PixelmonTrainerAdventure.deploy("https://rc.pixelmon.club/api/");
