...
2. Run Unit test
```shell
yarn test:prototype:token
```
3. Deploy Contract
```shell
yarn deploy:prototype:contract:goerli
```
4. Publish Contract
```shell
yarn publish:contract:goerli <new deployed contract address>
```

## Deployed Smart Contract in Test Network
1. Prototype Token (Coin): https://goerli.etherscan.io/address/0x7f512f2162fee6ced9122f8fc38ddd1aaba90c0b
